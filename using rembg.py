...
def process_inside(input_path):
    ...
    output_path = fr'data\inside\output{random.randint(0, 19023847192384)}.png'
...
def process_outside(input_path):
    root = r'D:\Data\inside_outside_s\vehicles'
    input_path = os.path.join(root, input_path)
...
def inside():
    file_path = r"D:\Data\Inside_Outside\non-vehicles"
    # with Pool() as p:
